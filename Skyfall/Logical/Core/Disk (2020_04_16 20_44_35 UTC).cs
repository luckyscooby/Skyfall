...
namespace Skyfall
{
    partial class Kernel
    {
        ...
        private const string NOTIFICATIONS_LOG_FILE = ".Notifications.htm";
        ...
        public static async void PackFile(string inputFile)
        {
            try
            {
                ...
                {
                    await Task.Run(() => archive.CreateEntryFromFile(inputFile, inputFile, CompressionLevel.NoCompression));
                }
